  ...
  return (
    <div className='termsofUsePage__container'>
      ...
      <div className='container'>
        ...
        <div className='termsofUsePage__box'>

        
        <h1 className='termsofUsePage__header'>Пользовательское соглашениея</h1>

        <p className='termsofUsePage__title'>Пользовательское соглашение</p>

        <p className='termsofUsePage__text'>Настоящее Соглашение заключается между Индивидуальным предпринимателем Юлдашевым Рустамом Муратхановичем (ИНН 160102860817) (далее – Владелец) и любым лицом, становящимся после принятия условий данного соглашения пользователем сайта, расположенного в сети Интернет по адресу: https://cygenic.tech (далее – Сайт), в дальнейшем именуемым «Пользователь», вместе по тексту Соглашения именуемые «Стороны», а по отдельности – «Сторона». В соответствии со статьей 435 Гражданского кодекса РФ настоящее Пользовательское соглашение признается офертой. В соответствии со статьей 438 Гражданского кодекса РФ безусловным принятием (акцептом) условий настоящего Соглашения считается факт регистрации на Сайте. Настоящее Соглашение, заключаемое путем акцепта настоящей оферты, не требует двустороннего подписания и действительно в электронном виде.</p>

        <p className='termsofUsePage__title'>1. Термины и определения, используемые в Соглашении</p>

        <p className='termsofUsePage__text'>В Соглашении, если из текста Соглашения прямо не вытекает иное, следующие слова и выражения будут иметь указанные ниже значения:

1.1. Сайт – совокупность программных и аппаратных средств для ЭВМ, обеспечивающих публикацию для всеобщего обозрения информации и данных, объединенных общим целевым назначением, посредством технических средств, применяемых для связи между ЭВМ в сети Интернет. Сайт находится в сети Интернет по адресу: https://cygenic.tech.

1.2. Администратор/Владелец Сайта – Индивидуальный предприниматель Юлдашев Рустам Муратханович (ИНН 160102860817), расположенное по адресу: https://cygenic.tech.
...
3.2.4. Направлять Пользователю информацию о развитии Сайта и его сервисов; отправлять sms-сообщения с целью информирования о кодах активации, проведения опросов о качестве работы Сайта, предоставления и запросов прочей информации, а также рекламировать собственную деятельность и услуги.</p>

        <p className='termsofUsePage__title'>4. Права и обязанности Пользователя</p>

        <p className='termsofUsePage__text'>4.1. Пользователь обязуется:
...
4.3.3. Самостоятельно редактировать ранее размещенную о себе информацию на Сайте. 4.3.4. Обратиться в службу поддержки для блокирования своего Профиля (при отсутствии действующих демодоступов и подписок).
...
4.4.3. В целях реализации настоящего Соглашения Пользователи дают Владельцу Сайта разрешение на использование, хранение, обработку и распространение персональных данных тем способом и в той мере, в которой это необходимо для исполнения условий настоящего Соглашения. Порядок использования, хранения, обработки и распространения персональных данных Пользователей размещен на Сайте по адресу: https://cygenic.tech. Пользователь соглашается на передачу третьим лицам персональных и иных данных, в том числе для целей их обработки, для обеспечения функционирования Сайта, реализации партнерских и иных программ, при условии обеспечения в отношении передаваемых данных режима, аналогичного режиму, существующему на Сайте, в том числе включая, но не ограничиваясь, передачу персональных данных лицам, аффилированным с Индивидуальным предпринимателем Юлдашевым Рустамом Муратхановичем или заключившим с ними договоры, а также третьим лицам в случаях, когда такая передача необходима для использования Пользователем определенного сервиса либо для исполнения определенного соглашения или договора с Пользователем. Обработка персональных данных осуществляется в соответствии с политикой по обработке персональных данных https://cygenic.tech/politica</p>

        <p className='termsofUsePage__title'>5. Регистрация Пользователя</p>

        <p className='termsofUsePage__text'>5.1. В целях пользования услугами, предоставляемыми Владельцем Сайта по настоящему Соглашению, Пользователь должен пройти обязательную процедуру регистрации на Сайте по адресу https://cygenic.tech. Регистрация Пользователя на Сайте является бесплатной, добровольной.
...
7.4. При недостижении согласия между Сторонами путем переговоров спор, вытекающий из настоящего Соглашения, подлежит рассмотрению в суде общей юрисдикции по месту нахождения Владельца Сайта.</p>

        <p className='termsofUsePage__title'>8. Прочие условия</p>

        <p className='termsofUsePage__text'>8.1. Настоящее Соглашение вступает в силу с момента акцепта настоящей оферты Пользователем и заключается на неопределенный срок.
